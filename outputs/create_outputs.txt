...
## AUTHOR:  Evelyn Jade
## DESCRIPTION: Uses a subset of processed, filtered data from the main analysis to generate all plots and outputs.
##              The scripts here have identical output to the output scripts in the main directory, but some of the 
...
echo --------------------------------------------------------------------------
echo \($(date +"%Y-%m-%d %T")\) WORKING ON: Selecting genes near high-assocition SNPs
cd files
